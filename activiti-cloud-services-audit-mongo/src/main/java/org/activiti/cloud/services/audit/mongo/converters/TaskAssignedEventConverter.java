...
@Component
public class TaskAssignedEventConverter implements EventToEntityConverter<AuditEventDocument> {
    ...
    public AuditEventDocument convertToEntity(CloudRuntimeEvent cloudRuntimeEvent) {
        ...
        TaskAssignedEventDocument taskAssignedEventEntity = new TaskAssignedEventDocument(cloudTaskAssignedEvent.getId(),
    ...
    public CloudRuntimeEvent convertToAPI(AuditEventDocument auditEventEntity) {
        TaskAssignedEventDocument taskAssignedEventEntity = (TaskAssignedEventDocument) auditEventEntity;
