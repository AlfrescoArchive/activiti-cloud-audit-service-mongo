...
@QueryEntity
public class TaskCancelledEventDocument extends TaskAuditEventDocument {

    protected static final String TASK_CANCELLED_EVENT = "TaskCancelledEvent";

    public TaskCancelledEventDocument() {
    }

    public TaskCancelledEventDocument(String eventId,
                                      Long timestamp,
                                      String cause) {
        super(eventId,
              timestamp,
